...
3. **Improve asteroid details**  
   Extend the API response types to match what’s defined as `N/A` in the collapsible section of the `AsteroidListItem`. Extract the collapsible part into a separate component.
